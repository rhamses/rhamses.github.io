  ...
  projects: [
    {
      ...
      details: [
        ...
        { label: 'My role', value: ['Front-end Developer', 'Designer', 'Back-end Developer', 'DevOps'] },
      ...
      screenshots: [
        { src: import('@/assets/portfolio/fipe-1.png'), alt: 'First screenshot' },
        { src: import('@/assets/portfolio/fipe-2.png'), alt: 'Second screenshot' },
      ],
      description:
      ...
      links: [demo({ url: 'https://fipe.amb1.io' })],
    },
    {
      name: 'Hashflags',
      ...
      screenshots: [{ src: import('@/assets/portfolio/hashflags-1.png'), alt: 'First screenshot' }],
      pdfDetails: [
        { label: 'Demo', value: 'https://hashflags.amb1.io', url: '#' },
        { label: 'Repository', value: 'https://github.com/rhamses/hashflags', url: '#' },
      ],
...
5- An api That parses the raw file and the MongoDB instance data to provide a stream of all time data that it contains.`,
      ...
      links: [demo({ url: 'https://hashflags.amb1.io' })],
    },
  ],
